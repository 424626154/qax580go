		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://yx.hcsat.cn";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://yx.hcsat.cn";
y.url = function() {
	return "http://yx.hcsat.cn?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://yx.hcsat.cn/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("916源代码—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("916源代码", "Arial", 12);
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://yx.hcsat.cn"
			}, this);
