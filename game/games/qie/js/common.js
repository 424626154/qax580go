...
;~function(bt){
	...
	bt.URL = {
		root: "http://yx.hcsat.cn"
		,getMoreGame: function(){
			// 点击更多
			bt.dc("more");
			
			return "http://yx.hcsat.cn";
		}
		,getConcern: function(){
			return "http://mp.weixin.qq.com/s?__biz=MjM5Mzg3NDAzOQ==&mid=201404088&idx=1&sn=0a24d67fcf10153e974f3478017a010a#rd";
		}
